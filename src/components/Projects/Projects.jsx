                    ...
                    <Row className='justify-content-evenly mt-2 mb-4' role="list">
                        <Col xs='10' lg='3' className='projects-card-mini text-center mt-3' role="listitem">
                            ...
                            <a href="https://compirooms.netlify.app/" target="_blank">
                                <img src="https://res.cloudinary.com/dbtmrinwa/image/upload/v1697036164/czuemis1mfinxmuhgpbs.jpg" alt="COMPI ROOMS Project screenshot" role="img" aria-label="COMPI ROOMS Project Screenshot" />
                            </a>
                        ...
                        <Col xs='10' lg='3' className='projects-card-mini text-center mt-3' role="listitem">
                            ...
                            <a href="https://onlypizzas.fly.dev/" target="_blank">
                                <img src="https://res.cloudinary.com/dbtmrinwa/image/upload/v1697036131/uiriutfupwqjhlgwejf7.jpg" alt="ONLY PIZZAS Project screenshot" role="img" aria-label="ONLY PIZZAS Project Screenshot" />
                            </a>
                            <h4>{language === 'ENG' ? 'Developed with:' : 'Desarrollado con:'}</h4>
                        ...
                        <Col xs='10' lg='3' className='projects-card-mini text-center mt-3' role="listitem">
                            ...
                            <a href="https://recheitor.github.io/M1Project/" target="_blank">
                                <img src="https://res.cloudinary.com/dbtmrinwa/image/upload/v1697036184/otd2rhxmrgor55qrmtyg.jpg" alt="JUMPER TRAVELER Project screenshot" role="img" aria-label="JUMPER TRAVELER Project Screenshot" />
                            </a>
                            <h4>{language === 'ENG' ? 'Developed with:' : 'Desarrollado con:'}</h4>
